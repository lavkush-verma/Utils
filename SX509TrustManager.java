...
public class SX509TrustManager implements X509TrustManager {
    private ArrayList<X509TrustManager> mX509TrustManagers = new ArrayList<X509TrustManager>();

    protected SX509TrustManager(InputStream keyStore, String keyStorePassword) throws GeneralSecurityException {
